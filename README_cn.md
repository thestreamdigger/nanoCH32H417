...
### MounRiver Studio 下载
可在官网[MounRiver Studio](http://www.mounriver.com)下载IDE，选择最新版本(MRS2)下载即可。
...
## 烧录
工程已经内置脚本，将V3F和V5F两个项目的代码自动拼接成单独文件Merge.bin, 鼠标点击选择V5F工程(因为Merge.bin是在V5F工程下生成的)，然后点击 闪存 -> 下载 即可完成烧录
