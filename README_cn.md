...
# 芯片资源
![CH32H417QEU6](https://github.com/wuxx/nanoCH32H417/blob/master/doc/CH32H417_Resource.jpg)
...
![MRS-2](https://github.com/wuxx/nanoCH32H417/blob/master/doc/MRS-2-CN.png)  
点击 工程 -> 编译全部 对工程进行编译  (会分别编译两个核心V3F和V5F的代码)
![MRS-3](https://github.com/wuxx/nanoCH32H417/blob/master/doc/MRS-3-CN.png)

## 烧录
工程已经内置脚本，将V3F和V5F两个项目的代码自动拼接成单独文件Merge.bin, 选择V5F工程，然后点击 闪存 -> 下载 即可完成烧录，
![MRS-4](https://github.com/wuxx/nanoCH32H417/blob/master/doc/MRS-4-CN.png)
